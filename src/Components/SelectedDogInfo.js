    ...
    render (){
        ...
        return(
           <div className="selectedPetInfo">
               ...
               <div className="container center">
                    <div className="row justify-content-center">
                        <div className="col-md-auto">
                            <img className="petImg" src={this.state.petImg} alt="chosen pet"/>
               ...
               {/* husky pet info */}
               {this.state.breed.value === "German Shepard" ? <div className="container center">
                    <div className="row justify-content-center">
                        <div className="col-md-auto">
                            <h2>Training</h2>
                ...
                {this.state.breed.value === "Husky" ? <div className="container center">
                    <div className="row justify-content-center">
                        <div className="col-md-auto">
                            <h2>Training</h2>
                            <div className="bulletList">
